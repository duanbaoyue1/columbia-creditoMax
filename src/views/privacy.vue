<template>
  <div class="h5-content content-area">
    ...
    <br />
    <br />
    <strong>3. ¿Compartimos sus datos personales con terceros?</strong>
    <br />
    <br />
    ...
    <br />
    <br />
    <strong>4. Conservación y eliminación de datos</strong>
    <br />
    <br />
    ...
    <br />
    <br />
    <strong>5. Cambios en la Política de Privacidad</strong>
    <br />
    <br />
    ...
    <br />
    <br />
    <strong>6. Póngase en contacto con nosotros</strong>
    <br />
    <br />
